...
module.exports = class DealCards extends deckofcards {
    ...
    constructor(noofPlayers) {
        ...
        console.log("Playe count " + this.PlayerCount);
    ...
    evaluate() {
        ...
        console.log('evaluate normal mode ' + playersEvaluatedHand);
    ...
    Newevaluate(PotDistribution) {
        ...
        console.log('Pot distribution --- '+pot_Distribution);

        //allplayerHandEvaluator =[];
        for (let i = 0; i < pot_Distribution.length; i++) {
            allplayerHandEvaluator.push(new HandEvaluator(sortedPlayersHand[pot_Distribution[i]]));
        }
